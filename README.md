# Sistema-Distribuido-en-3-Capas-Axel-Gaona
...
```bash
ssh axelon@localhost -p 2221  # Entrada a la VM1
```
---
...
```Bash
scp -P 2222 server.js axelon@localhost:~/app/
```
